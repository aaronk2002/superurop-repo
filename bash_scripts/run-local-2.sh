...
do
   ...
   python ../local_convergence.py -n 6 -T 8 -d 10 -p 2 --lr 0.1 --epochs 3_000 --seed $seed --normalized --parameterization KQ --std 1 --output ../result/convergence/p2/KQ$seed.pt
done
...
python ../local_convergence.py -n 6 -T 8 -d 10 -p 2 --lr 0.1 --epochs 3_000 --seed 1 --normalized --parameterization KQ --std 0.01 --output ../result/convergence/p2/SingleKQ.pt